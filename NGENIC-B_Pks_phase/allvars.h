...
double PowerSpec2ndg(double kmag);
...
extern char     FileWithInputSpectrumDM[500];
extern char   FileWithInputSpectrumB[500];
extern char     FileWithInputSpectrumDMpmf[500];
extern char   FileWithInputSpectrumBpmf[500];
...
extern int Seed;
extern int Seedb;
extern double klimitB;

extern double B1mpc;
extern double nB;
extern double kappa_b, kappa_dm, p_shape, coeff;
extern double lambda_pmf_b, lambda_pmf_dm, lambda_lcdm_b, lambda_lcdm_dm;
extern double boost;
extern int same_phase;
