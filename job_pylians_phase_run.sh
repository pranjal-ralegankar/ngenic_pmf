...
#
#SBATCH --job-name=B_0_1_nB_2_0_box_1_256_phasePK_no_lcdm_3mesh       # The name of your job, you'll se it in squeue.
...
#   Example:
# 
cd /scratch/pralegan/ngenic_pmf/phase_ics_v2/NGENIC-B_Pks_phase
gmake
mpirun -np 4 ./N-GenIC parameterfiles/B_0_1_nB_2_0_box_1_256_phasePK_no_lcdm_3mesh.param
cd ..
mkdir pylians_output/B_0_1_nB_2_0_box_1_256_phasePK_no_lcdm_3mesh
python3 powerspectra_run.py
